<div>
    <aside
        class="hs-overlay overflow-y-auto transform lg:block lg:end-auto lg:bottom-0 fixed top-0 with-vertical h-screen z-[999] flex-shrink-0 border-r-[1px] w-[300px] border-border-1 dark:border-borderDark-1 bg-[var(--sidebar)] left-sidebar sidebar-transition"
